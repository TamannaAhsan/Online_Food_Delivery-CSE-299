    ...
    <body>
        ...
        <div id="Navigation-bar">
         ...
         <div class="Search-Bar">
             ...
             <form action=>
             <input type="search" value="Search for your desired food..." style="font-size: larger;color:#1256FD ">
        ...
        <div id="Cuisines">
             ...
             <h2 class="text-align" style="margin-bottom:-200px;" ><a href="#">Outstanding Categories</a></h2>
            
           <div class="image_style">
                <img src= "homepagephotos\BangladeshiCuisine.jpg"  alt="Bangladeshi Cuisine" class="ResponsiveImage" style="width:200px;height:200px;border-radius: 50px;" class="ResponsiveImage">
            ...
            <div class="container">
             ...
             <h2 class="text-align"><a href="#">Explore Menu </a></h1>
             <div class="Food-List">
